//
//  PVBaseStationConfig.h
//  PVSDK
//
//  Created by Layne on 2017/6/28.
//  Copyright © 2017年 Layne. All rights reserved.
//

#import <Foundation/Foundation.h>
#import "PVBaseComponent.h"
#import <PVSDK/PVBaseStationConfigDelegate.h>

@interface PVBaseStationConfig : PVBaseComponent
...
/**
 *  PVBaseStationConfig的delegate对象
 */
@property (nonatomic,weak)id <PVBaseStationConfigDelegate>delegate;

/**
 *  返回默认的PVBaseStationConfig单例对象，该对象会被自动构建
 */
