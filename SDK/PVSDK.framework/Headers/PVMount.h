...
@class PVMount;
@protocol PVMountDelegate <NSObject>
...
- (void)pv_mount:(PVMount * _Nonnull)mount reciveUartData:(PVSDK_MOUNTAPI_UART_DATA)mData;
 ...
 */
- (void)pv_mount:(PVMount * _Nonnull)mount reciveCanData:(PVSDK_MOUNTAPI_CAN_DATA)mData;


@end

@interface PVMount : PVBaseComponent

NS_ASSUME_NONNULL_BEGIN     // Attribute in its rang will getattr nonnull

@property (nonatomic,weak)id <PVMountDelegate> delegate;
